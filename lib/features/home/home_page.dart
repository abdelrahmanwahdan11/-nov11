              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        _quickAction(
                          ...
                          label: l10n.getString('quickActionDiagnostics'),
                          onTap: () =>
                    ...
                    const SizedBox(height: 24),
                    ValueListenableBuilder<List<DeviceDiagnostic>>(
                      valueListenable: diagnostics.diagnosticsNotifier,
                      builder: (context, diagnosticsList, _) {
                        if (diagnosticsList.isEmpty) {
                          return const SizedBox.shrink();
                        }
                        final flagged = diagnosticsList
                            .where((item) => item.isFlagged)
                            .toList();
                        return _DiagnosticsPreview(
                          flagged: flagged,
                          l10n: l10n,
                          onTap: () =>
                              Navigator.of(context).pushNamed('/diagnostics'),
...
class _DiagnosticsPreview extends StatelessWidget {
  ...
  final List<DeviceDiagnostic> flagged;
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final hasFlagged = flagged.isNotEmpty;
    final subtitle = hasFlagged
        ? l10n
            .getString('homeDiagnosticsPreviewFlagged')
            .replaceFirst('{count}', flagged.length.toString())
        : l10n.getString('homeDiagnosticsPreviewClear');
            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          l10n.getString('homeDiagnosticsPreviewTitle'),
              ...
              if (hasFlagged) ...[
                ...
                Wrap(
                  spacing: 12,
                  runSpacing: 12,
                  children: flagged.take(3).map((diagnostic) {
                    final statusColor =
                        _statusColor(theme, diagnostic.status);
                    return _DiagnosticsStatusChip(
                      label: diagnostic.deviceName,
                      status:
                          l10n.getString(diagnostic.statusLocalizationKey),
                      color: statusColor,
                    );
                  }).toList(),
                ),
              ...
              TextButton.icon(
                ...
                label: Text(l10n.getString('homeDiagnosticsPreviewCta')),
              ),
            ],
          ),
        ),
