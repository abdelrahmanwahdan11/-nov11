...
class AppScope extends InheritedWidget {
  const AppScope({super.key, required this.appController, required this.catalogController, required this.compareController, required this.favoritesController, required this.cartController, required super.child});
